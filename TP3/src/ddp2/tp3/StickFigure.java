...
// Increase the height by the given factor
// (if the factor is > 1 the figure will "grow" else it will shrink)
    ...
    public void setAllPosition(int newArm, int newLeg) {
        setArmPosition(newArm);
        setLegPosition(newLeg);
    }

// set the legPosition (dist. from vertical) to new value
