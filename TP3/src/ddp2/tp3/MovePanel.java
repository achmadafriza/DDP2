...
// legs to go up, m puts them in the middle, and d down.

    public void keyPressed (KeyEvent event)
        {
            switch (event.getKeyCode())
            {
                case KeyEvent.VK_LEFT: stickMan.move(-1*JUMP, 0); break;
                case KeyEvent.VK_RIGHT: stickMan.move(JUMP, 0); break;
                case KeyEvent.VK_UP: stickMan.move(0, -1*JUMP); break;
                case KeyEvent.VK_DOWN: stickMan.move(0, JUMP); break;
                case KeyEvent.VK_G: stickMan.grow (1.5); break;
                case KeyEvent.VK_S: stickMan.grow (0.5); break;
                case KeyEvent.VK_U: stickMan.setAllPosition(60, 40); break;
                case KeyEvent.VK_M: stickMan.setAllPosition(0, 20); break;
                case KeyEvent.VK_D: stickMan.setAllPosition(-60, 10); break;
                default:
            }
